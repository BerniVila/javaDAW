...
public class FirstDatabaseConnection {
	...
	public static void main(String[] args) {
		try {
			...
			PreparedStatement preparedStatement = connect.prepareStatement("insert into  students values ( ?, ?)");
			...
			preparedStatement = connect.prepareStatement("SELECT code, name from students");
