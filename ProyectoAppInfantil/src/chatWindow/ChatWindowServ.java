...
public class ChatWindowServ {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ChatWindowServ window = new ChatWindowServ();
	...
	private void initialize() {
		...
		btnSend.setIcon(new ImageIcon(ChatWindowServ.class.getResource("/images/icons/send-message-icon.png")));
