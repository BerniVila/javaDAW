...
public class ChatWindowCLIPruebas {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ChatWindowCLIPruebas window = new ChatWindowCLIPruebas();
	...
	private void initialize() {
		...
		btnSend.setIcon(new ImageIcon(ChatWindowCLIPruebas.class.getResource("/images/icons/send-message-icon.png")));
