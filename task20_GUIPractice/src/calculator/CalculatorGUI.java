...
public class CalculatorGUI {
	...
	private void initialize() {
		...
		btn_AC.setBackground(new Color(153, 102, 204));
		...
		btn_negative.setBackground(new Color(153, 102, 204));
		...
		btn_perCent.setBackground(new Color(153, 102, 204));
		...
		btn_multiplication.setBackground(new Color(153, 102, 204));
		...
		btn_substraction.setBackground(new Color(153, 102, 204));
		...
		btn_addition.setBackground(new Color(153, 102, 204));
		...
		btn_point.setBackground(new Color(255, 255, 255));
		...
		btn_equal.setBackground(new Color(153, 102, 204));
