...
public class CalculatorGUI {
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 489, 619);
		...
		frame.getContentPane().add(lblShowOperation, gbc_lblShowOperation);
		
		JButton btn_AC = new JButton("AC");
		btn_AC.setFont(new Font("Yu Gothic Medium", Font.BOLD, 24));
		...
		gbc_btn_AC.gridx = 0;
		gbc_btn_AC.gridy = 2;
		frame.getContentPane().add(btn_AC, gbc_btn_AC);
		
		JButton btn_negative = new JButton("+/-");
		btn_negative.setFont(new Font("Yu Gothic Medium", Font.BOLD, 24));
		...
		frame.getContentPane().add(btn_negative, gbc_btn_negative);
		
		JButton btn_perCent = new JButton("%");
		btn_perCent.setFont(new Font("Yu Gothic Medium", Font.BOLD, 24));
		...
		frame.getContentPane().add(btn_perCent, gbc_btn_perCent);
		
		JButton btn_division = new JButton("\t\u00F7");
		btn_division.setFont(new Font("Yu Gothic Medium", Font.BOLD, 40));
		btn_division.setBackground(new Color(153, 153, 255));
		...
		frame.getContentPane().add(btn_division, gbc_btn_division);
		
		JButton btn_7 = new JButton("7");
		btn_7.setFont(new Font("Yu Gothic Medium", Font.BOLD, 24));
		...
		btn_8.setFont(new Font("Yu Gothic Medium", Font.BOLD, 24));
		...
		btn_9.setFont(new Font("Yu Gothic Medium", Font.BOLD, 24));
		...
		btn_multiplication.setFont(new Font("Yu Gothic Medium", Font.BOLD, 24));
		...
		frame.getContentPane().add(btn_multiplication, gbc_btn_multiplication);
		
		JButton btn_4 = new JButton("4");
		btn_4.setFont(new Font("Yu Gothic Medium", Font.BOLD, 24));
		...
		btn_5.setFont(new Font("Yu Gothic Medium", Font.BOLD, 24));
		...
		btn_6.setFont(new Font("Yu Gothic Medium", Font.BOLD, 24));
		...
		btn_substraction.setFont(new Font("Yu Gothic Medium", Font.BOLD, 40));
		...
		frame.getContentPane().add(btn_substraction, gbc_btn_substraction);
		
		JButton btn_1 = new JButton("1");
		btn_1.setFont(new Font("Yu Gothic Medium", Font.BOLD, 24));
		...
		btn_2.setFont(new Font("Yu Gothic Medium", Font.BOLD, 24));
		...
		btn_3.setFont(new Font("Yu Gothic Medium", Font.BOLD, 24));
		...
		btn_addition.setFont(new Font("Yu Gothic Medium", Font.BOLD, 24));
		...
		frame.getContentPane().add(btn_addition, gbc_btn_addition);
		
		JButton btn_0 = new JButton("0");
		btn_0.setFont(new Font("Yu Gothic Medium", Font.BOLD, 24));
		...
		btn_point.setFont(new Font("Yu Gothic Medium", Font.BOLD, 24));
		...
		frame.getContentPane().add(btn_point, gbc_btn_point);
		
		JButton btn_equal = new JButton("=");
		btn_equal.setMargin(new Insets(0, 0, 0, 0));
		btn_equal.setFont(new Font("Yu Gothic Medium", Font.BOLD, 55));
		...
		frame.getContentPane().add(btn_equal, gbc_btn_equal);
	}
